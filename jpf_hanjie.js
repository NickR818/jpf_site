...
function init() {
   ...
   // and an event listener to the Show Solution button
...
function setupPuzzle() {
   ...
   // Create arry variables of all the filled and all the empty cells
   ...
   // Create an event listener for the peek button to highlight incorrect cells
